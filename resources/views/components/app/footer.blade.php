<footer class="footer p-5 ">
    <div class="row align-items-center justify-content-lg-between ">
        <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="copyright text-center text-m text-muted text-sm-start" style="font-size: 12px">
                Copyright
                ©
                <script>
                ...
                {{-- made with  --}}
                <i class="fa fa-heart"></i> by ARDHIKA 'KOBRA' S. TAMA & RIZKY 'BORAKS' A. KURNIAWAN
