                            ...
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent text-center">
                                    ...
                                    <p class="mb-0">Password: <b>secret</b></p> --}}
                                      <p class="mb-0">Email: <b>admin@makopala.org</b></p>
                                    <p class="mb-0">Password: <b>request by admin</b></p>
                                </div>
                                    ...
                                    <form role="form" class="text-start" method="POST" action="sign-in">
                                        ...
                                        <div class="mb-3">
                                            {{-- <input type="email" id="email" name="email" class="form-control"
                                             ...
                                             <input type="email" id="email" name="email" class="form-control"
                                                placeholder="Enter your email address"
                                                value="{{ old('email') ? old('email') : 'admin@makopala.org' }}"
                                                aria-label="Email" aria-describedby="email-addon">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" id="password" name="password"
                                                value="{{ old('password') ? old('password') : 'makopala2025' }}"
                                                class="form-control" placeholder="Enter password" aria-label="Password"
                                                aria-describedby="password-addon">                                            
                                        </div>
